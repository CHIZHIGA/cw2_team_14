...
class Metaclass_Example_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('cw1_team_14')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_Example(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from cw1_team_14.srv import _example
...
class Example(metaclass=Metaclass_Example):
    from cw1_team_14.srv._example import Example_Request as Request
    from cw1_team_14.srv._example import Example_Response as Response
