...
bool cw1_team_14__srv__example__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cw1_team_14.srv._example.Example_Request", full_classname_dest, 40) == 0);
  }
  cw1_team_14__srv__Example_Request * ros_message = _ros_message;
  {  // example_float
...
PyObject * cw1_team_14__srv__example__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("cw1_team_14.srv._example");
...
ROSIDL_GENERATOR_C_EXPORT
bool cw1_team_14__srv__example__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cw1_team_14.srv._example.Example_Response", full_classname_dest, 41) == 0);
  }
  cw1_team_14__srv__Example_Response * ros_message = _ros_message;
  {  // success
