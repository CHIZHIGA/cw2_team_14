...
#include "cw1_team_14/srv/detail/example__rosidl_typesupport_fastrtps_c.h"
...
#include "cw1_team_14/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_cw1_team_14
...
using _Example_Request__ros_msg_type = cw1_team_14__srv__Example_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cw1_team_14
size_t get_serialized_size_cw1_team_14__srv__Example_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Example_Request__ros_msg_type * ros_message = static_cast<const _Example_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Example_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cw1_team_14__srv__Example_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cw1_team_14
size_t max_serialized_size_cw1_team_14__srv__Example_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cw1_team_14__srv__Example_Request;
    is_plain =
      (
...
static size_t _Example_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cw1_team_14__srv__Example_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cw1_team_14, srv, Example_Request)() {
...
using _Example_Response__ros_msg_type = cw1_team_14__srv__Example_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cw1_team_14
size_t get_serialized_size_cw1_team_14__srv__Example_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Example_Response__ros_msg_type * ros_message = static_cast<const _Example_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_cw1_team_14__srv__Example_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cw1_team_14
size_t max_serialized_size_cw1_team_14__srv__Example_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cw1_team_14__srv__Example_Response;
    is_plain =
      (
...
static size_t _Example_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cw1_team_14__srv__Example_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cw1_team_14, srv, Example_Response)() {
...
// already included above
// #include "cw1_team_14/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "cw1_team_14/srv/example.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cw1_team_14, srv, Example)() {
