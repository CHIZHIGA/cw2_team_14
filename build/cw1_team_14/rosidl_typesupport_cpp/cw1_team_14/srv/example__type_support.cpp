...
static const _Example_Request_type_support_symbol_names_t _Example_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cw1_team_14, srv, Example_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cw1_team_14, srv, Example_Request)),
  }
};
...
{
  return &::cw1_team_14::srv::rosidl_typesupport_cpp::Example_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cw1_team_14, srv, Example_Request)() {
  return get_message_type_support_handle<cw1_team_14::srv::Example_Request>();
}
...
static const _Example_Response_type_support_symbol_names_t _Example_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cw1_team_14, srv, Example_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cw1_team_14, srv, Example_Response)),
  }
};
...
{
  return &::cw1_team_14::srv::rosidl_typesupport_cpp::Example_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cw1_team_14, srv, Example_Response)() {
  return get_message_type_support_handle<cw1_team_14::srv::Example_Response>();
}
...
static const _Example_type_support_symbol_names_t _Example_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cw1_team_14, srv, Example)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cw1_team_14, srv, Example)),
  }
};
...
{
  return &::cw1_team_14::srv::rosidl_typesupport_cpp::Example_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, cw1_team_14, srv, Example)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<cw1_team_14::srv::Example>();
}
